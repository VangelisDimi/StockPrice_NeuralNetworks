...
class CNN_autoencoder():
    def __init__(self, dataset, batch_size=3, num_epochs=10, train_size=0.8):
        ...
        conv1_1 = Conv1D(16, 3, activation="relu", padding="same")(conv1_1)
        conv1_1 = BatchNormalization()(conv1_1)
        pool1 = MaxPooling1D(strides=2, padding="same")(conv1_1)
        conv1_2 = Conv1D(8, 3, activation="relu", padding="same")(pool1)
        conv1_2 = BatchNormalization()(conv1_2)
        conv1_2 = Conv1D(1, 3, activation="relu", padding="same")(conv1_2)
        conv1_2 = BatchNormalization()(conv1_2)
        conv1_2 = Conv1D(1, 3, activation="relu", padding="same")(conv1_2)
        conv1_2 = BatchNormalization()(conv1_2)
        ...
        conv2_1 = Conv1D(1, 3, activation="relu", padding="same")(conv2_1)
        conv2_1 = BatchNormalization()(conv2_1)
        up1 = UpSampling1D(2)(conv2_1)
        conv2_2 = Conv1D(16, 3, activation='relu', padding="same")(up1)
        conv2_2 = BatchNormalization()(conv2_2)
        conv2_2 = Conv1D(16, 3, activation='relu', padding="same")(conv2_2)
        conv2_2 = BatchNormalization()(conv2_2)
        up2 = UpSampling1D(2)(conv2_2)
        conv2_3 = Conv1D(8, 3, activation='relu', padding="same")(up2)
        conv2_3 = BatchNormalization()(conv2_3)
        decoded = Conv1D(1, 3, activation='sigmoid', padding='same')(conv2_3)
        #Compile
